...
This document is a general howto on how to build a CardDAV client originally created as part of the [sabre.io documentation](http://sabre.io/dav/building-a-carddav-client/), copied here and adjusted just slightly not to link within the rest of the documentation.
