...
[draft-ietf-calext-extensions-05](https://tools.ietf.org/html/draft-ietf-calext-extensions-05) now recommends that UID values be formed from hex-encoded UUID values.
